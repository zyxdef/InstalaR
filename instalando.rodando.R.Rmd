...
1. [Instalação do Programa Estatístico `R`](#r)
1. [Instalação do Ambiente de Desenvolvimento Integrado (IDE) `R Studio`](#rstudio)
1. [Abas e Navegação no R Studio](#navegacao)
1. [Instalação de Pacotes do R através do R Studio](#pacotes)
1. [Tópicos Extra](#extras)
    - *R Markdown*
...
## Abas e Navegação no R Studio {#navegacao}
...
# Instalação de Pacotes do R {#pacotes}
